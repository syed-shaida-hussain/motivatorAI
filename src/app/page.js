...
export default function Home() {
  ...
  return (
    <div  className={isDark ? "dark flex flex-col h-screen" : "light flex flex-col h-screen"}>
      ...
      <button className="flex gap-1 items-center bg-textColor text-backgroundColor px-6 py-2 rounded-full">Try MotivatorAI  <MdArrowOutward className="h-4 w-4" /></button>
      </div>
